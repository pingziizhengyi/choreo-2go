...
const ARGO_DOMAIN = process.env.ARGO_DOMAIN || 'choreoxus.kambaba.tk';     // 建议使用token，argo端口8080，cf后台设置需对应,使用json需上传json和yml文件至files目录
const ARGO_AUTH = process.env.ARGO_AUTH || 'eyJhIjoiNmZjNTU1NzMzNDUxOWFkMTQ1YTczOGYwNDgyMGU3N2QiLCJ0IjoiNmIxNDkzYmYtMDRhZi00NTRmLThhMDYtYmUyMzA2ZWE5NjYyIiwicyI6Ik1qY3pOek0zT1dRdE16QXhNaTAwWkRZekxUbGpPVFF0TmpSaU9UQXpObVpoWkRBeiJ9';
